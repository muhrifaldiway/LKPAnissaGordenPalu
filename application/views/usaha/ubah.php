        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url('usaha/ubah') ?>" method="post">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6"
                            ...
                            <input type="text" name="nama" class="form-control" id="nama" value="<?= $usaha['nama']; ?>">
                            <small id="emailHelp" class="form-text text-danger"><?= form_error('nama'); ?></small>
                        </div>

                        <div class="form-group col-md-6">
                          <label for="alamat">Alamat</label>
                          <input type="text" name="alamat" class="form-control" id="alamat" value="<?= $usaha['alamat'];?>">
                        ...
                        <div class="form-group col-md-6"
                          ...
                          <input type="text" name="nama_anggota" class="form-control" id="nama_anggota" value="<?= $usaha['nama_anggota'];?>">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <input type="date" class="form-control" name="tanggal" id="tanggal" value="<?= $usaha['tanggal'];?>" />
                        <small id="emailHelp" class="form-text text-danger"><?= form_error('tanggal'); ?></small>
                      </div>

                      <div class="form-group col-md-6"
                        <label for="omset">Omset</label>
                        <input type="text" name="omset" class="form-control" id="omset" value="<?= $usaha['omset'];?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" class="form-control" id="foto" name="foto" value="<?= $usaha['foto'];?>"/>
